...
class UnetPlusPlus(nn.Module):
    ...
    def forward(self, x):
        ...
        # up_0_1 = self.upsample_0_1(x_1_0)
        # up_0_1 = crop_to_match(up_0_1, x_0_0)  # 裁剪
        # x_0_1 = torch.cat([up_0_1, x_0_0], 1)
        # x_0_1 = self.CONV0_1(x_0_1)

        x_0_1 = torch.cat([crop_to_match(self.upsample_0_1(x_1_0), x_0_0), x_0_0], 1)
        x_0_1 = self.CONV0_1(x_0_1)

        x_1_1 = torch.cat([crop_to_match(self.upsample_1_1(x_2_0), x_1_0), x_1_0], 1)
        x_1_1 = self.CONV1_1(x_1_1)

        x_2_1 = torch.cat([crop_to_match(self.upsample_2_1(x_3_0), x_2_0), x_2_0], 1)
        x_2_1 = self.CONV2_1(x_2_1)

        x_3_1 = torch.cat([crop_to_match(self.upsample_3_1(x_4_0), x_3_0), x_3_0], 1)
        x_3_1 = self.CONV3_1(x_3_1)

        x_2_2 = torch.cat([crop_to_match(self.upsample_2_2(x_3_1), x_2_0), x_2_0, x_2_1], 1)
        x_2_2 = self.CONV2_2(x_2_2)

        x_1_2 = torch.cat([crop_to_match(self.upsample_1_2(x_2_1), x_1_0), x_1_0, x_1_1], 1)
        x_1_2 = self.CONV1_2(x_1_2)

        x_1_3 = torch.cat([crop_to_match(self.upsample_1_3(x_2_2), x_1_0), x_1_0, x_1_1, x_1_2], 1)
        x_1_3 = self.CONV1_3(x_1_3)

        x_0_2 = torch.cat([crop_to_match(self.upsample_0_2(x_1_1), x_0_0), x_0_0, x_0_1], 1)
        x_0_2 = self.CONV0_2(x_0_2)

        x_0_3 = torch.cat([crop_to_match(self.upsample_0_3(x_1_2), x_0_0), x_0_0, x_0_1, x_0_2], 1)
        x_0_3 = self.CONV0_3(x_0_3)

        x_0_4 = torch.cat([crop_to_match(self.upsample_0_4(x_1_3), x_0_0), x_0_0, x_0_1, x_0_2, x_0_3], 1)
        ...
        if self.deep_supervision:
            ...
            logits = self.final_super_0_4(x_0_4)
...
if __name__ == "__main__":
    ...
    inputs = torch.randn((1, 3, 564, 565)).to(device)
